...
public class CategorizerCommandLineArgs {
    ...
    @Parameters(commandNames = { "categorize-entries" }, commandDescription = "Categorize public Dockstore entries into ontology categories using AI. Use the upload-categories command to upload these categories to Dockstore.")
    ...
    @Parameters(commandNames = { "upload-categories" }, commandDescription = "Upload AI-generated ontology categories, generated by the categorize-entries command, for public Dockstore entries.")
    public static class UploadCategoriesCommand {
