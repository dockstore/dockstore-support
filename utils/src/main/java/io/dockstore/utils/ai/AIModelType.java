...
public enum AIModelType {
    CLAUDE_3_5_SONNET("us.anthropic.claude-3-5-sonnet-20240620-v1:0", 0.003 / 1000, 0.015 / 1000, 200000),
    CLAUDE_3_HAIKU("us.anthropic.claude-3-haiku-20240307-v1:0", 0.00025 / 1000, 0.00125 / 1000, 200000),
    CLAUDE_4_5_HAIKU("us.anthropic.claude-haiku-4-5-20251001-v1:0", 0.001 / 1000, 0.005 / 1000, 200000);
